...
fn main() {
    //assumptions
    //these will be passed in later via smth
    ...
    for i in 0..160 {
        ...
        let y0 = y_ndc(baseline_y + glyf.y_min as f32 * scale, screen_h);
        let x1 = x_ndc(baseline_x + glyf.x_max as f32 * scale, screen_w);
        let y1 = y_ndc(baseline_y + glyf.y_max as f32 * scale, screen_h);
        println!("{}, {}, {}, {}", x0, y0, x1, y1);
    }
}
#[inline(always)]
